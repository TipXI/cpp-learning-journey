#include <iostream>
using namespace std;
const int ARRAY_SIZE = 10;// constants gloual varible
...
int main()
{
    ...
    printArray(listA, ARRAY_SIZE); 
    cout << endl; 
    cout << "Line 14: The sum of the elements of listA is: "<< sumArray(listA, ARRAY_SIZE) << endl<< endl; 
    cout << "Line 15: The position of the largest element in listA is: "<< (indexLargestElement(listA, ARRAY_SIZE)+1)<< endl; 
    cout << "Line 16: The largest element in listA is: "<< listA[indexLargestElement(listA, ARRAY_SIZE)]<<endl;
    copyArray(listA, 0, listB, 3, ARRAY_SIZE); 
    cout << "Line 18: After copying the elements of listA into listB, listB elements are: "<< endl; 
    printArray(listB, ARRAY_SIZE); 
    cout << endl; 
    return 0;
}
