#include <iostream >             //Program: Sentinel-Controlled Loop
#include <string>                //This program computes and outputs the total number of boxes of
#include <iomanip>               //cookies sold, the total revenue, and the average number of
using namespace std;             //boxes sold by each volunteer.
